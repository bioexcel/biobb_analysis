...
[![](https://img.shields.io/badge/docker-Quay.io-blue)](https://quay.io/repository/biocontainers/biobb_analysis)
...
* Installation:
        ...
        pip install "biobb_analysis>=3.7.0"
...
* Installation:
        ...
        conda install -c bioconda "biobb_analysis>=3.7.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_analysis:3.7.0--pyhdfd78af_1


* Usage:


        docker run quay.io/biocontainers/biobb_analysis:3.7.0--pyhdfd78af_1 <command>
