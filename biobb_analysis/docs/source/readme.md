...
* Installation:
        ...
        pip install "biobb_analysis>=3.0.2"
...
* Installation:
        ...
        conda install -c bioconda "biobb_analysis>=3.0.2"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_analysis:3.0.2--py_0


* Usage:


        docker run quay.io/biocontainers/biobb_analysis:3.0.2--py_0 <command>
