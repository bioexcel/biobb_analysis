...
* Installation:
        ...
        pip install "biobb_analysis>=3.6.0"
...
* Installation:
        ...
        conda install -c bioconda "biobb_analysis>=3.6.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_analysis:3.6.0--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_analysis:3.6.0--pyhdfd78af_0 <command>
