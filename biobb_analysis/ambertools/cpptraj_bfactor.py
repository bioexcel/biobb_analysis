...
class Bfactor():
    """Wrapper of the Ambertools Cpptraj module. Calculating B-Factor.
    ...
    def create_instructions_file(self):
        ...
        instructions_list += get_reference(reference, self.output_cpptraj_path, self.input_exp_path, ref_mask, False, self.__class__.__name__)
        instructions_list.append('atomicfluct out ' + self.output_cpptraj_path + ' byres bfactor')
...
def main():
    parser = argparse.ArgumentParser(description="Wrapper for the Ambertools Cpptraj module. Calculating B-Factor.", formatter_class=lambda prog: argparse.RawTextHelpFormatter(prog, width=99999))
