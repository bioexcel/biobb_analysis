...
class CpptrajBfactor():
    ...
    Args:
        ...
        output_cpptraj_path (str): Path to the output processed analysis. File type: output. `Sample file <https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/ambertools/ref_cpptraj.bfactor.first.dat>`_. Accepted formats: dat, agr, xmgr, gnu.
        properties (dic):
