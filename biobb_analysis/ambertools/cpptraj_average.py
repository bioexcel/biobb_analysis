...
class CpptrajAverage():
    ...
    Args:
        input_top_path (str) [file_in:[Sample file](https://raw.githubusercontent.com/bioexcel/biobb_analysis/master/biobb_analysis/test/data/ambertools/cpptraj.parm.top)]: Path to the input structure or topology file. Accepted formats: top, pdb, prmtop, parmtop, zip.
