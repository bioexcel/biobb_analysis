...
class CpptrajAverage():
    ...
    Args:
        input_top_path (str) (`Cpptraj manual <https://amber-md.github.io/cpptraj/CPPTRAJ.xhtml>`_): Path to the input structure or topology file. Accepted formats: top, pdb, prmtop, parmtop, zip.
