...
class CpptrajAverage():
    ...
    Args:
        ...
        output_cpptraj_path (str): Path to the output processed structure. File type: output. `Sample file <https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/ambertools/ref_cpptraj.average.pdb>`_. Accepted formats: crd (edam:format_3878), netcdf (edam:format_3650), rst7 (edam:format_3886), ncrst (edam:format_2033), dcd (edam:format_3878), pdb (edam:format_1476), mol2 (edam:format_3816), binpos (edam:format_3885), trr (edam:format_3910), xtc (edam:format_3875), sqm (edam:format_2033).
        properties (dic):
            * **start** (*int*) - (1) [1~100000|1] Starting frame for slicing.
            * **end** (*int*) - (-1) [-1~100000|1] Ending frame for slicing.
            * **in_step** (*int*) - (1) [1~100000|1] Step for slicing.
    ...
    def __init__(self, input_top_path, input_traj_path,
        ...
        self.step =  properties.get('in_step', 1)
    ...
    def check_data_params(self, out_log, err_log):
        ...
        self.in_parameters = { 'start': self.start, 'end': self.end, 'step': self.step, 'mask': self.mask }
