...
class CpptrajAverage():
    ...
    Args:
        input_top_path (str) [I'm an inline-style link](https://www.google.com): Path to the input structure or topology file. Accepted formats: top, pdb, prmtop, parmtop, zip.
