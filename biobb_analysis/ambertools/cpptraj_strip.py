...
from biobb_analysis.ambertools.common import get_default_value, check_top_path, check_traj_path, check_out_path, get_binary_path, get_in_parameters, get_out_parameters, get_mask
...
class CpptrajStrip(BiobbObject):
    ...
    @launchlogger
    def launch(self) -> int:
        """Execute the :class:`CpptrajStrip <ambertools.cpptraj_strip.CpptrajStrip>` object."""
...
main = CpptrajStrip.get_main(cpptraj_strip, "Strips a defined set of atoms (mask) from a given cpptraj compatible trajectory.")
