...
def main():
    parser = argparse.ArgumentParser(description="Wrapper for the Ambertools Cpptraj module. Stripping a trajectory.", formatter_class=lambda prog: argparse.RawTextHelpFormatter(prog, width=99999))
