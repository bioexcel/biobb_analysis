...
class CpptrajImage(BiobbObject):
    ...
    @launchlogger
    def launch(self) -> int:
        """Execute the :class:`CpptrajImage <ambertools.cpptraj_image.CpptrajImage>` object."""
...
main = CpptrajImage.get_main(cpptraj_image, "Corrects periodicity (image) from a given cpptraj trajectory file.")
