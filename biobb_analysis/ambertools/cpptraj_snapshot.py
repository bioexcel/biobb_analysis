...
class Snapshot():
    ...
    def create_instructions_file(self):
        ...
        # trajin
        in_params = get_in_parameters(self.in_parameters, self, 'snapshot')
...
def main():
    parser = argparse.ArgumentParser(description="Wrapper of the Ambertools Cpptraj module. Calculating a snapshot structure.")
