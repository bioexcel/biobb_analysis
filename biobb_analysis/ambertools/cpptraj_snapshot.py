...
def main():
    parser = argparse.ArgumentParser(description="Wrapper of the Ambertools Cpptraj module. Calculating a snapshot structure.", formatter_class=lambda prog: argparse.RawTextHelpFormatter(prog, width=99999))
