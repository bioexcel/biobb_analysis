...
from biobb_analysis.ambertools.common import get_default_value, check_top_path, check_traj_path, check_out_path, get_binary_path, get_in_parameters, get_out_parameters, get_negative_mask
...
class CpptrajSlice(BiobbObject):
    ...
    Args:
        ...
        output_cpptraj_path (str): Path to the output processed trajectory. File type: output. `Sample file <https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/ambertools/ref_cpptraj.slice.netcdf>`_. Accepted formats: mdcrd (edam:format_3878), crd (edam:format_3878), netcdf (edam:format_3650), nc (edam:format_3650), rst7 (edam:format_3886), ncrst (edam:format_2033), dcd (edam:format_3878), pdb (edam:format_1476), mol2 (edam:format_3816), binpos (edam:format_3885), trr (edam:format_3910), xtc (edam:format_3875), sqm (edam:format_2033).
    ...
    @launchlogger
    def launch(self) -> int:
        """Execute the :class:`CpptrajSlice <ambertools.cpptraj_slice.CpptrajSlice>` object."""
...
main = CpptrajSlice.get_main(cpptraj_slice, "Extracts a particular trajectory slice from a given cpptraj compatible trajectory.")
