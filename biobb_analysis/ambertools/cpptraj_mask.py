...
class Mask():
    ...
    def create_instructions_file(self):
        ...
        in_params = ''
        if in_parameters:
            in_params = get_in_parameters(self.in_parameters, self, 'mask')
...
def main():
    parser = argparse.ArgumentParser(description="Wrapper of the Ambertools Cpptraj module. Masking a trajectory.")
