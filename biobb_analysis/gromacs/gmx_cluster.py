...
class GMXCluster(BiobbObject):
    ...
    Args:
        ...
        output_cluster_log_path (str) (Optional): Path to the output log file. File type: output. `Sample file <https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/gromacs/gmx_cluster_cluster.log>`_. Accepted formats: log (edam:format_2330).
        output_rmsd_cluster_xpm_path (str) (Optional):Path to the output X PixMap compatible matrix file. File type: output. `Sample file <https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/gromacs/gmx_cluster_rmsd-clust.xpm>`_. Accepted formats: xpm (edam:format_3599).
        output_rmsd_dist_xvg_path (str) (Optional): Path to xvgr/xmgr file. File type: output. `Sample file <https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/gromacs/gmx_cluster_rmsd-dist.xvg>`_. Accepted formats: xvg (edam:format_2330).
