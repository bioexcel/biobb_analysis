...
def main():
    ...
    GMXRgyr(input_structure_path=args.input_structure_path, input_traj_path=args.input_traj_path, input_index_path=args.input_index_path, output_xvg_path=args.output_xvg_path, properties=properties).launch()
