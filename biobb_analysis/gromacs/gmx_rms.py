...
class GMXRms():
    ...
    Wrapper of the `GROMACS rms <http://manual.gromacs.org/current/onlinehelp/gmx-rms.html>`_ module.
    ...
    Args:
        ...
        output_xvg_path (str): Path to the XVG output file. File type: output. `Sample file <https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/gromacs/ref_rms.xvg>`_. Accepted formats: xvg.
        properties (dic):
...
def main():
    ...
    GMXRms(input_structure_path=args.input_structure_path, input_traj_path=args.input_traj_path, output_xvg_path=args.output_xvg_path, input_index_path=args.input_index_path, properties=properties).launch()
